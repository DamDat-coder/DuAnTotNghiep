...
export default function NewsSection() {
  ...
  if (!newsItems.length) {
    return (
      <div className="max-w-md mx-auto tablet:max-w-2xl desktop:max-w-4xl py-4">
  ...
  return (
    <div className="max-w-md mx-auto tablet:max-w-2xl desktop:max-w-4xl">
      ...
      <Swiper
        spaceBetween={16}
        slidesPerView={1} // Mobile: 1 slide để chắc chắn không tràn
        loop={false}
        grabCursor={true}
        className="select-none max-w-full" // Giới hạn Swiper trong container
        breakpoints={{
