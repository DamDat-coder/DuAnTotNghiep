...
export default function ProductDetail({ params }: { params: { id: string } }) {
  ...
  // Dữ liệu gợi ý cho Section 5 (giả lập)
  const suggestedProducts = [
    { id: 2, name: "Áo thun unisex", price: 500000, discountPercent: 20, image: "featured_1.jpg", category: "Áo thun" },
    { id: 3, name: "Quần jeans slim", price: 800000, discountPercent: 15, image: "featured_1.jpg", category: "Quần jeans" },
    { id: 4, name: "Giày sneakers trắng", price: 1200000, discountPercent: 10, image: "featured_1.jpg", category: "Giày" },
    { id: 5, name: "Mũ lưỡi trai đen", price: 300000, discountPercent: 25, image: "featured_1.jpg", category: "Phụ kiện" },
    { id: 6, name: "Áo khoác bomber", price: 1500000, discountPercent: 30, image: "featured_1.jpg", category: "Áo khoác" },
  ];
  ...
  return (
    <div className="min-h-screen">
      <div className="max-w-5xl mx-auto">
        <Breadcrumb />
        <div className="max-w-sm mx-auto mt-4 flex flex-col gap-9">
          {/* Section 1 */}
          <div className="">
