        ...
        <table className="min-w-full text-sm text-left">
          <thead className="bg-[#F8FAFC] text-[#94A3B8]">
            <tr className="overflow-hidden">
              <th className="w-[130px] px-4 py-0 rounded-tl-[12px] rounded-bl-[12px]">
                Tác giả
              </th>
              <th className="w-[380px] px-4 py-0">Tiêu đề</th>
              <th className="w-[200px] px-4 py-0">Danh mục</th>
              <th className="w-[156px] px-4 py-0">Ngày đăng</th>
