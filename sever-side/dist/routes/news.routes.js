...
router.post("/", auth_middleware_1.verifyToken, news_controller_1.upload.array("images", 10), news_controller_1.createNews);
router.put("/:id", auth_middleware_1.verifyToken, news_controller_1.upload.array("images", 10), news_controller_1.updateNews);
